<?php
/**
 * Shims for editor autocompletion.
 *
 * These class aliases are used (and created) by the WordPress test suite to
 * maintain compatibility with different versions of PHP Unit.
 */

/**
 * {@inheritDoc}
 *
 * The parent class to `WP_UnitTestCase`.
 */
